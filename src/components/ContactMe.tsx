...
import { Textarea } from "./ui/inputarea";

export function ContactMe({ id }: { id: string }) {
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        console.log("Form submitted");
    };
    return (
        <div id={id} className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-12 shadow-input bg-black">
            ...
            <form className="my-8" onSubmit={handleSubmit}>
                ...
                <LabelInputContainer className="mb-4">
                    ...
                    <Input id="email" placeholder="projectmayhem@fc.com" type="textarea" />
                </LabelInputContainer>
                <LabelInputContainer className="mb-8">
                    <Label htmlFor="message">Message</Label>
                    <Textarea id="message" placeholder="Enter the message here" />
                </LabelInputContainer>
